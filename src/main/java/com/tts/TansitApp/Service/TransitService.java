package com.tts.TansitApp.Service;


import com.tts.TansitApp.Model.*;
...
public class TransitService {
  ...
  private double getDistance(Location origin, Location destination) {
    ...
    return response.rows.get(0).element.get(0).distance.value * 0.000621371;
  }

  public List<Bus> getNearbyBuses(BusRequest request) {
    List<Bus> allBuses = this.getBus();
